    ...
    <div>
        <div className='text-4xl font-semibold text-center my-10'>
          ...
          <div className='text-center text-richblack-700 mx-auto text-base font-medium lg:w-[75%] leading-6 mt-3'>
            Using spin making learning multiple language easy with 20+ languages realistic voice-over, progress tracking, custom schedule and more.
          </div>
          ...
          <div className='flex flex-col lg:flex-row items-center justify-center mt-8 lg:mt-0'>
            ...
            />
            <img src={plan_your_lesson} alt="knowyourprogress" 
